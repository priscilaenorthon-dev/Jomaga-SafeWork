...
const roadmapPhases: RoadmapPhase[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        status: 'partial',
        desc: 'Relatório Mensal de Segurança em PDF profissional com identidade visual da empresa já disponível.',
        details: 'A geração do Relatório Mensal de Segurança já sai em layout profissional com logo da empresa, cabeçalho padronizado, KPIs e tabelas consolidadas. Fichas de EPI e lista de DDS também imprimem com branding; próximos PDFs especializados seguem em expansão.',
        benefits: [
          'Relatório mensal padronizado pronto para auditoria',
          'Identidade visual aplicada via Configurações > Empresa',
          'Exportação rápida com um clique',
          'Base pronta para expansão de novos modelos PDF',
        ],
        example: 'Ex: Clique em "Relatório Mensal de Segurança" → abre documento profissional para impressão/Salvar como PDF com KPIs, histórico mensal e pendências.',
      },
    ],
  },
  {
